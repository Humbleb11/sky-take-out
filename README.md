...
>
>不管是分类还是套餐呀，菜品呀，它们的相关增删改查的代码的相似度还是挺高的，所以就不一一列出了，就取一个典型就可以了，但是在整个CRUD的编写中，我还是运用了一些比较方便的方法去让码代码更简单。
### 基于注解和AOP的公共字段填充：
...
## 等等先别走 我的百度地图开发者认证终于来了
咱又来举一个例子，假如我是一名中国人名大学的大佬，我想吃一点家乡的味道，我直接猛然坐起，打开苍穹外卖，一看，想走一个点外卖的流程，点一个来自家乡重庆的外卖，咱还是留一个心眼，咱把地址填学校，不然真给我支付成功了，如图

![](https://gitee.com/humbleb11/image/raw/e50b623cac6f01594c16ead547f02e88788bf5ce/32.png)

我简直馋的要死，直接点支付，哪能一看，直接支付成功了，，，我直接傻眼，对哈！！！地址的配送范围也是个问题，所以得找个办法确认一下顾客的配送地址是否在店铺的周围所以我紧急接入百度地图，库库写，终于如愿以尝，来看看效果吧
先来看看微信小程序端的报错

![](https://gitee.com/humbleb11/image/raw/e50b623cac6f01594c16ead547f02e88788bf5ce/31.png)

再来看看服务器的报错
>ERROR 21912 --- [nio-8080-exec-5] com.sky.handler.GlobalExceptionHandler   : 异常信息：超出配送范围

终于是解决这个问题了，我一直担心百度地图开发者认证一直不认证，幸好来咯，还是挺让人开心的qwq
